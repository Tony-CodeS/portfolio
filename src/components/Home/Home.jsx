    ...
    <div id='mobileimage'>
      ...
      <div id='Home'>
        <div id='intro-div'>
            ...
            {/*button div  */}
            <div id='btn-div'>
                <button id='hire-button'> <a href='https://wa.me/08088589379' id='hire-button-a'> Hire ME <CgProfile size={30} id='download-icon'/> </a> </button>
                <button id='download-btn'>Download Resume <ImDownload size={30} id='download-icon'/> </button> 
            </div>
            {/*  */}
            <div>
                <ul id='socials'>
                    <li id='socials-li'> <a href='https://wa.me/08088589379' id='a'>  <BsWhatsapp size={30} id='aa'/></a>  </li>
